...
def render_report_converter() -> None:
    ...
    with left:
        ...
        st.subheader("2) 러시아어 원문")
        raw_text = st.text_area("원문을 붙여넣으세요", height=400, key="conv_input", label_visibility="collapsed")
        ...
        if run:
            with st.spinner("변환 중..."):
                try:
                    ...
                    st.session_state["conv_result"] = format_report(report)
